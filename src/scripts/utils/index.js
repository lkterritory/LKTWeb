...
export function debounce(func, wait, immediate) {
  ...
  return function (...args) {
    ...
    // timeout === false, then set timeout
...
export function getDeviceType() {
  ...
  var isUc7 = sUserAgent.match(/rv:1.2.3.4/i) == "rv:1.2.3.4"; //CVS
  ...
  var isKiosk = sUserAgent.match(/xbox/i) == "xbox";
  var isPda = sUserAgent.match(/pda/i) == "Pda";
