          ...
          <v-row class="d-flex justify-start align-center">
            ...
            <v-col cols="12">
              <div class="modal-item rounded-lg">
                <v-text-field
                  type="input"
                  v-model="this.filterQuery.itemNm"
                  variant="plain"
                  hide-details="false"
                  @keypress.enter="save()"
                  ...
                  solo
                  :placeholder="
                    this.$t('wcs.exec.execItemStatus.pleaseSelectItemCd')
                  ">
                  <template v-slot:prepend>
                    <v-label class="modal-item-divider labels">
                      {{ $t("wcs.exec.execItemStatus.skuCd") }}
                    </v-label>
                  </template>
                </v-text-field>
              </div>
  ...
  methods: {
    ...
    async save() {
      ...
      lktBody.push({
        ...
        skuCode: this.filterQuery.itemNm
      });
